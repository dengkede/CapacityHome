...
public class StoreComnoAdapter extends BaseAdapter {
    private Context context;
    private List<JSONObject> jsonObjects;

    public StoreComnoAdapter(Context context, List<JSONObject> jsonObjects) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            view = LayoutInflater.from(context).inflate(R.layout.combo_item,null);
