...
package com.example.administrator.capacityhome.smarthome.video.zxing;
...
final class CameraConfigurationManager extends Activity {
...
//    screenResolution = new Point(mSize.x, mSize.y);
  ...
  void setDesiredCameraParameters(Camera camera) {
	  Base_camera=camera;
    Camera.Parameters parameters = Base_camera.getParameters();
   ...
   // parameters.set("orientation", "portrait");
    ...
    Base_camera.setDisplayOrientation(90);
   ...
   /* if (Integer.parseInt(Build.VERSION.SDK) >= 8)
    ...
    Base_camera.setParameters(parameters);
  }
