...
public class BounceScrollView_refresh extends ScrollView {
    ...
    public BounceScrollView_refresh(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
