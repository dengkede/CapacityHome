...
public class NumberProgressView extends View {
     ...
     * 进度条画笔的宽度（dp）
     */
    private int paintProgressWidth = 12;

    /**
     * 文字百分比的字体大小（sp）
     */
    private int paintTextSize = 12;

    /**
     * 左侧已完成进度条的颜色
     */
    private int paintLeftColor = 0xffff1a80;

    /**
     * 右侧未完成进度条的颜色
     */
    private int paintRightColor = 0xfff2f2f2;

    /**
     * 百分比文字的颜色
     */
    private int paintTextColor = 0x00000000;
    ...
    private void initData() {
        ...
        //设置进度条画笔的宽度
        int paintProgressWidthPx = DisplayUtil.dip2px(paintProgressWidth);

        //设置百分比文字的尺寸
        int paintTextSizePx = DisplayUtil.sp2px(paintTextSize);
