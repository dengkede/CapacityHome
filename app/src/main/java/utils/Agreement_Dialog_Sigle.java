 ...
 */
public class Agreement_Dialog_Sigle extends AlertDialog implements View.OnClickListener {
    ...
    private View view;
    public Agreement_Dialog_Sigle(Context context, String content) {
        super(context);
        this.mContext = context;
        setCanceledOnTouchOutside(false);
    }

    public Agreement_Dialog_Sigle(Context context, Onclick onclick) {
    ...
    private void initView() {
       // setContentView(R.layout.agreement_dialog_sigle);
        view = getLayoutInflater().inflate(R.layout.agreement_dialog_sigle, null);
...
//        tv_title.setText(title);
        ...
        webView.loadUrl(RequestTag.ArticaleUrl+RequestTag.ARTICAL_SIGLE+"&mark=company");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.tv_agree:
                ...
                Agreement_Dialog_Sigle.this.dismiss();
                break;
        }
