...
public class SPUtils {
    ...
    public static void clear(Context context) {
        ...
        sp.edit().remove("user_json");
        sp.edit().remove("password");
        editor.clear();
        editor.commit();
        editor = null;
//        try {
//            if(SPUtils.getSharedStringData(context,"user_json")==null){
//                Log.d("sdddd","name null");
//            }
//            if(SPUtils.getSharedStringData(context,"password")==null){
//                Log.d("sdddd","password null");
//            }
//            if(SPUtils.getSharedStringData(context,"user_json")!=null){
//                Log.d("sdddd",SPUtils.getSharedStringData(context,"user_json").toString());
//            }
//            if(SPUtils.getSharedStringData(context,"password")!=null){
//                Log.d("sdddd",SPUtils.getSharedStringData(context,"password"));
//            }
//        }catch (Exception e){
//            Log.d("sdddd",e.toString());
//        }
    }
